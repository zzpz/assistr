...
const cardFooterContent = (
    <EuiFlexGroup justifyContent="spaceAround">
      ...
      <EuiFlexItem grow={false}>
        <EuiButton href="/chat" onClick={chat}>Chat</EuiButton>
      </EuiFlexItem>
      <EuiFlexItem grow={false}>
        <EuiButton  onClick={refreshPage}>Remove</EuiButton>
      </EuiFlexItem>
    </EuiFlexGroup>
);
  ...
  <div>
    <EuiFlexItem grow={3}>
            <StyledProfileSubsection verticalPosition="center" horizontalPosition="center">
                <EuiText> You havent applied for any opportunities yet</EuiText>
...
var statusButton = (
  <div>
    <EuiButton fill isLoading={true}>Processing</EuiButton>
  </div>
)

function chat() {
  localStorage.setItem("applySuccess", "true")
}

if (localStorage.getItem("applySuccess") == "true") {
  statusButton = (
    <div>
      <EuiButton color="success" fill iconType="check" >Accepted</EuiButton>
    </div>
  )
}
...
var loadingAccept = (
  <div>
    <EuiFlexGroup justifyContent="spaceBetween">
        <EuiFlexItem grow={false}>
          <EuiText><h3>Bloom Festival</h3></EuiText>
        </EuiFlexItem>
        <EuiFlexItem grow={false}>
      ...
      <EuiPageBody component="section">
        ...
        <ProfileContainer>
          <EuiFlexGroup>
            ...
            <EuiFlexItem grow={3}>
            <StyledProfileSubsection verticalPosition="center" horizontalPosition="center">
                <EuiText> <h3>My Applications</h3></EuiText>
...
export default connect((state) => ({ user: state.auth.user }))(MyOpportunities)
